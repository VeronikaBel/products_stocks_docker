...
-Вам необходимо будет прогнать миграции:
...
Перед началом убедитесь,что у Вас установлен Docker.desktop и в терминале выполнена команда Docker login
...
3. Запустите контейнер:
   docker run -d -p порт:порт название_образа
